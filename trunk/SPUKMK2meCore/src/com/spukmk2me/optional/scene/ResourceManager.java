...
public final class ResourceManager
{
     ...
     * mobile devices.
     */
    public void LoadResources( InputStream is, ResourceProducer producer )
        throws IOException
    {
        /* $if SPUKMK2ME_SCENESAVER$ */
        Clear();
     ...
     *  @param sceneFileDirectory The absolute path to scene file location.
     *  @param srcPathSeparator Path separator which is used.
