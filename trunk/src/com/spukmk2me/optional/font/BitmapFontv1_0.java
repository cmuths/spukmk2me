 ...
 */
public final class BitmapFontv1_0 extends ICFont
{
    /**
     ...
     */
    public BitmapFontv1_0( InputStream is ) throws IOException
    {
...
//#         }
    ...
    private void CalculateCharactersWidth()
    {
        ...
        boolean stopLine;
        byte    currentByte;
        byte    checkByte = (byte)((1 << m_bitDepth) - 1);
