...
public final class KeyCodeAdapter {
     ...
     */
    public static void StartFilteringKeyCodes( Canvas canvas )
    {
        PLATFORM_NAME = getPlatform();
        SOFTKEY_LEFT = getLeftSoftkeyCode( canvas );
        SOFTKEY_RIGHT = getRightSoftkeyCode( canvas );
        SOFTKEY_MIDDLE_INTERNET = getMidleORInternetSoftkeyCode( canvas );
        SOFTKEY_DELETE = getDeleteKeyCode( canvas );
...
//            }
     ...
     * @return code
     */
    private static int getLeftSoftkeyCode( Canvas canvas ) {
        int keyCode = 0;
        try {
...
//                String leftkeySamsungName = canvas.getKeyName(SOFT_KEY_LEFT_SAMSUNG).toUpperCase();
...
//#                  return SOFT_KEY_LEFT_NOKIA;
     ...
     * @return code
     */
    private static int getRightSoftkeyCode( Canvas canvas ) {
        int keyCode = 0;
        try {
            if (PLATFORM_NAME.equals(PLATFORM_MOTOROLA)) {
...
//                String rightSoftSamsung = canvas.getKeyName(SOFT_KEY_RIGHT_SAMSUNG).toUpperCase();
...
//#             return SOFT_KEY_RIGHT_NOKIA;
     ...
     * @return code
     */
    public static int getMidleORInternetSoftkeyCode( Canvas canvas ) {
        try {
            if (PLATFORM_NAME.equals(PLATFORM_MOTOROLA)) {
     ...
     * @return code
     */
    public static int getDeleteKeyCode( Canvas canvas ) {
        try {
            if (PLATFORM_NAME.equals(PLATFORM_MOTOROLA)) {
